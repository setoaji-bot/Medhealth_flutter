                  ...
                  Stack(
                    ...
                    IconButton(
                      onPressed:(){
                        ...
                        MaterialPageRoute(builder:(context)=>CartPages(totalCart)));
                      }, 
                      icon:Icon(
          ...
          filter 
            ? index == 7 ? Text("Feature on Proggress") :
              GridView.builder(
                ...
                shrinkWrap: true,
                gridDelegate: 
                  SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 1, crossAxisSpacing:16, mainAxisSpacing: 15),
                itemBuilder: (context, i){
